...
This file is the quick-reference operating contract for pulldown-cmark-kotlin. The longer
...
pulldown-cmark-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`pulldown-cmark`](https://crates.io/crates/pulldown-cmark). Upstream Rust is the behavioral oracle while the
