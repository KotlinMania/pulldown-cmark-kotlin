...
kotlin {
    ...
    val xcf = XCFramework("PulldownCmark")

    macosArm64 {
        binaries.framework { baseName = "PulldownCmark"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "PulldownCmark"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "PulldownCmark"
        flattenPackage = "io.github.kotlinmania.pulldowncmark"
    }

    android {
        namespace = "io.github.kotlinmania.pulldowncmark"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "pulldown-cmark-kotlin", version.toString())

    pom {
        name.set("pulldown-cmark-kotlin")
        description.set("Kotlin Multiplatform port of raphlinus/pulldown-cmark - A pull parser for CommonMark")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/pulldown-cmark-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/pulldown-cmark-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/pulldown-cmark-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/pulldown-cmark-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assemblePulldownCmarkXCFramework",
    "assemblePulldownCmarkDebugXCFramework",
    "assemblePulldownCmarkReleaseXCFramework",
    "assembleDebugIosFatFrameworkForPulldownCmarkXCFramework",
    "assembleReleaseIosFatFrameworkForPulldownCmarkXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForPulldownCmarkXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForPulldownCmarkXCFramework",
    "assembleDebugMacosFatFrameworkForPulldownCmarkXCFramework",
    "assembleReleaseMacosFatFrameworkForPulldownCmarkXCFramework",
    "assembleDebugTvosFatFrameworkForPulldownCmarkXCFramework",
    "assembleReleaseTvosFatFrameworkForPulldownCmarkXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForPulldownCmarkXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForPulldownCmarkXCFramework",
    "assembleDebugWatchosFatFrameworkForPulldownCmarkXCFramework",
    "assembleReleaseWatchosFatFrameworkForPulldownCmarkXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForPulldownCmarkXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForPulldownCmarkXCFramework",
